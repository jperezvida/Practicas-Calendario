      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 w-full md:w-auto justify-between">
          ...
          <button 
            ...
            className="flex items-center gap-2 bg-indigo-600 text-white px-4 py-2 rounded-full text-xs font-bold shadow-md hover:bg-indigo-700 transition transform hover:scale-105 active:scale-95"
          >
        ...
        <div className="flex bg-gray-100 p-1 rounded-lg">
          <button 
            ...
            className={`px-4 py-1.5 rounded-md text-xs font-medium transition ${viewType === 'month' ? 'bg-white shadow-sm text-indigo-600' : 'text-gray-500 hover:text-gray-700'}`}
          >
            Mes
          </button>
          <button 
            onClick={() => setViewType('week')}
            className={`px-4 py-1.5 rounded-md text-xs font-medium transition ${viewType === 'week' ? 'bg-white shadow-sm text-indigo-600' : 'text-gray-500 hover:text-gray-700'}`}
          >
            Semana
          </button>
        </div>
